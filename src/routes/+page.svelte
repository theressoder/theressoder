...
<section class="relative bg-paper py-20 px-6 overflow-hidden">
    <div class="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-96 h-96 bg-accent opacity-10 rounded-full blur-3xl"></div>

    <div class="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12 relative z-10">
        
        <div class="text-center md:text-left max-w-2xl">
            <span class="inline-block py-1 px-3 mb-4 text-xs font-semibold tracking-widest text-ink uppercase bg-accent/30 rounded-full">
                Systemutvecklare & Pedagog
            </span>
            
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-ink leading-tight mb-6">
...
<!-- ABOUT -->
<section id="about" class="bg-paper py-24 px-6">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div class="w-full md:w-1/2 relative">
            ...
            <div class="absolute -top-6 -right-6 w-48 h-48 bg-ink opacity-5 rounded-full blur-3xl z-0"></div>
        </div>
        ...
        <div class="w-full md:w-1/2">
            ...
            <div class="space-y-6 text-ink/80 text-lg leading-relaxed">
                ...
                <p>
                    Steget till programmering var mer naturligt än jag först anade. Samma sökande efter svar som lockade mig till fysiken, fann jag i koden. Idag kombinerar jag min pedagogiska erfarenhet med systemutveckling för att skapa lösningar som inte bara är tekniskt stabila, utan också begripliga för människan som ska använda dem.
                </p>
                ...
                <p>
                    När jag inte sitter framför koden eller klurar på pedagogiska upplägg, hittar jag balansen i rörelse och kreativt hantverk. Löpningen är min ventil för att hämta ny kraft och lugna sinnet, medan stickning och virkning låter mig vara både metodisk och kreativ på samma gång. Det är i den kombinationen, hemma i Edsbyn, som jag laddar batterierna bäst.
                </p>
            </div>
        </div>
    </div>
...
<!-- PROJECTS -->
<section id="projects" class="bg-paper py-24 px-6 border-t border-ink/5">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white p-8 rounded-2xl border border-ink/5 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
                <div class="w-12 h-12 bg-accent/20 text-accent rounded-lg flex items-center justify-center mb-6 group-hover:bg-accent group-hover:text-white transition-colors">
                ...
                <div class="space-y-2 mb-6">
                    <span class="inline-block bg-ink/5 text-ink text-xs px-2 py-1 rounded">React</span>
            ...
            <div class="group bg-white p-8 rounded-2xl border border-ink/5 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
                ...
                <div class="space-y-2 mb-6">
                    <span class="inline-block bg-ink/5 text-ink text-xs px-2 py-1 rounded">Kursdesign</span>
            ...
            <div class="group bg-white p-8 rounded-2xl border border-ink/5 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
                ...
                <div class="space-y-2 mb-6">
                    <span class="inline-block bg-ink/5 text-ink text-xs px-2 py-1 rounded">Coaching</span>
